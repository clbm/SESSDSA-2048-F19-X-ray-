...
def Read_data():
    ...
    for result in F2.readlines():
        ...
        Tensor = torch.tensor([Array_value,Array_belong])
        yield Tensor.numpy(), int(Array_belong[I][J]<0)
    F1.close()
    F2.close()
